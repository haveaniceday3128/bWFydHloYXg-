...
UtilityPage.Button({
   ...
   wait(0.01)
   loadstring(game:HttpGet("https://raw.githubusercontent.com/PixCarAtHome/bWFydHloYXg-/main/TWFydHlIYXggQmxhdGFudA%3D%3D.lua"))()
   end
})
...
pcall(function()
    syn.protect_gui(game:GetService("CoreGui")["MartyHax Lite Watermark"])
end)
